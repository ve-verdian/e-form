...
?>
	...
	<div class="col-lg-6">	
		...
		<tr><td width="20%">Akses Menu</td><td><b><input type="text" class="form-control" name="akses_menu" id="akses_menu" tabindex="6" row="3" value="<?php echo $akses_menu; ?>"></tr>
		<tr><td width="20%">Tanggal Input</td><td><b><input type="text" name="tgl_surat" tabindex="7" required value="<?php echo $tgl_surat; ?>" id="tgl_surat" style="width: 100px" class="form-control"></b></td></tr>
		</table>	
	</div>
