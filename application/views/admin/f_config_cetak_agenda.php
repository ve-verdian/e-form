<div class="panel panel-info">
	<div class="panel-heading"><h3 style="margin-top: 5px">Cetak Daftar User</h3></div>
</div>

<div class="well">
<form action="<?php echo base_URL(); ?>admin/cetak_user_baru" target="blank" method="post" accept-charset="utf-8" enctype="multipart/form-data">	
