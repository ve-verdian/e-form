...
<table>
	<tr><td colspan="2" ><img src="http://192.168.100.66/e-form/aset/img/fam.png" style="width:155px;height:90px;" align="left">
	...
	<section>
	<tr><td colspan="2" align="center"><b style="font-size: 18px;">PERMINTAAN PENAMBAHAN USER</b></td></tr>
	</section>
	
	<section>
	<tr><td><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NAMA LENGKAP PEGAWAI <td width="60%">: <?php echo $datpil1->dari; ?></td></tr>
	...
	<tr><td><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;LOKASI <td width="10%">: </b><input class="form-check-input" type="checkbox" id="family" value="">
		<label class="form-check-label" for="family"><b>RSIA FAMILY</label>&nbsp;
		<input class="form-check-input" type="checkbox" id="grand" value="">
	...
	<tr><td colspan="2" style="line-height: 20px"><p align="justify">Selanjutnya disebut sebagai <b><i>USER,</i></b> dengan ini ingin diberikan : </p>
	<tr><td colspan="2" style="line-height: 20px"><p align="justify"><b><i>User Account :</i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input class="form-check-input" type="checkbox" id="simrs" value="">
		<label class="form-check-label" for="simrs"><b>SIMRS</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input class="form-check-input" type="checkbox" id="rscloud" value="">
		<label class="form-check-label" for="rscloud"><b>RSCLOUD</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input class="form-check-input" type="checkbox" id="pc" value="">
		<label class="form-check-label" for="pc"><b>PC</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input class="form-check-input" type="checkbox" id="email" value="">
		<label class="form-check-label" for="email"><b>EMAIL</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input class="form-check-input" type="checkbox" id="internet" value="">
		<label class="form-check-label" for="internet"><b>INTERNET</label>
		<br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="form-check-input" type="checkbox" id="lainnya" value="">
		<label class="form-check-label" for="lainnya"><b>LAINNYA ...</label>
		</td></tr>
		<tr><td colspan="2" style="line-height: 20px"><p align="justify">Pada Sistem Informasi Manajemen Rumah Sakit (SIMRS) untuk menjalankan pekerjaan sesuai dengan tanggung jawab yang diberikan. Adapun tanggung jawab yang diberikan adalah sebagai berikut :</p>
		<center><b><?php echo $datpil1->akses_menu; ?></b></center>
		</td>
		</tr>
		<td colspan="2" style="line-height: 20px"><p align="justify">Maka dengan ini ingin meminta persetujuan oleh Direktur Rumah Sakit untuk diberikan 
